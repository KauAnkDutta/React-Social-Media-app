...
import {Search, Person, Chat, Notifications, Explore} from '@material-ui/icons'
...
function TopBar(){
    ...
    const display_menu = () => {
        var myDiv = document.getElementById('link_main_container')
        if(myDiv.className === 'links_main_container'){
            myDiv.className += ' responsiveness'
        }else{
            myDiv.className = "links_main_container"
        }
    }
        ...
        <div className="topbarContainer">
            ...
            <div className="topbar_right">
                ...
                <div className="topbar_links_container">
                    <div className='topbar_link_icon' onClick={display_menu}><Explore/></div>
